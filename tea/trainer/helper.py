...
def explore_lr_and_plot(learner, train_loader, path, loss_fn=None, start_lr=1.0e-5, end_lr=1.0, batches=100):
    r = learner.find_lr(train_loader, loss_fn, path=path, start_lr=start_lr, end_lr=end_lr, batches=batches)
